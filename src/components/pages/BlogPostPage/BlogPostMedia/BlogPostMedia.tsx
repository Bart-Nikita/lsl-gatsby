            ...
            <div className={styles.left}>
                <div onClick={videoClickHandler} className={stack(styles.video, !isPlaying && styles.stop)}>
                    ...
                    <div className={styles.video__picture}>
                        <GatsbyImage className={'w-full h-full'} image={blogPostPage?.blog?.blogPostMediaZastavkaDlyaVideoKompyuter?.gatsbyImage} alt={blogPostPage?.blog?.blogPostMediaZastavkaDlyaVideoKompyuter?.altText}></GatsbyImage>
                    </div>
                </div>
