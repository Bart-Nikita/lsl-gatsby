    ...
    return (
        <div className={className ? className : ''}>
            ...
            <label className='flex gap-[12px] ' htmlFor={id}>
                ...
                {!isSmall && <p className='text-[20px] leading-[1.4] md:text-[16px]'>Я&nbsp;даю свое <a className='underline transition-all hover:opacity-70' target='_blank' href={footer?.footer?.footerSoglasieNaObrabotkuPersonalnyhDannyh?.publicUrl || ''}>согласие</a> на&nbsp;обработку моих персональных данных, в&nbsp;соответствии с&nbsp;Федеральным законом от&nbsp;27.07.2006 &#8470;&nbsp;152&#8209;фз &laquo;О&nbsp;персональных данных&raquo; и&nbsp;<a className='underline transition-all hover:opacity-70' target='_blank' href={footer?.footer?.footerPolitikaKonfidenczialnosti?.publicUrl || ''}>политикой конфиденциальности</a>, на&nbsp;условиях и&nbsp;для целей определенных в&nbsp;Согласии на&nbsp;обработку персональных данных</p>}
                {isSmall && <p className='text-[16px] leading-[1.4] '>Я&nbsp;согласен на&nbsp;получение информационной и&nbsp;<a className='underline transition-all hover:opacity-70' target='_blank' href={footer?.footer?.footerSoglasieNaReklamu?.publicUrl || ''}>рекламной рассылки</a></p>}
            </label>
        </div>
    )
}
